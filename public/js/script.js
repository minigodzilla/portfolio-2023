    ...
    "interactive-art": {
      ...
      pages: {
        "ancestors-gate": {
          ...
          heroVideo: true,
          content:
            "<p>The story of Indigenous language and cultural near-extinction, and later renaissance, has played out in parallel among the Indigenous peoples in North and South America, Australia and the Pacific, and elsewhere around the world. We can all point to a past generation of our respective peoples, within memory, who spoke our languages maternally.</p><p>Imagine yourself as one of the people of that generation -- perhaps someone in your own family who you knew, or know about, or someone in the Native community where you're from, or even their ancestors beyond that.</p><p>Imagine they're gifted with a time portal they can use to send *something* through to our generation. A way to communicate directly with us.</p><p>What kind of story, song, message or knowledge would they send to us?</p><p>Ancestors' Gate is this bridge across generations. It's an exercise in immersion using vintage technology. It's a new way to share Indigenous language, culture and storytelling using technology and interactive art -- a way which is meant to leave a lasting impression.</p><p>I have been co-researching old recordings of storytelling, folk songs, spoken word, and the like from past generations of First Nations and Indigenous peoples worldwide, with the close assistance of members of those communities. I'm also collecting old photos, film footage, and other visuals, as well as contemporarily-produced creative content.</p><p>I'm combining these vintage audio and visuals together artistically, and creating short videos. At launch, Ancestors' Gate showcased 4 videos, with more on the way.</p><p>The videos are shown at random on a vintage CRT TV, when someone picks up a vintage rotary telephone placed in front of it. After a short countdown, kaleidoscopic time-travel effects are projection-mapped all around the TV, creating a sense of awe and scale. Audio then plays through the receiver, exclusively for the listener, while the video plays on the TV.</p><p>At the end of the video, the listener is left with a writeup explaining what they just saw and heard, and a QR code they can scan to research further.</p><p>Ancestors' Gate debuted at the 2023 ImagineNATIVE Film + Media Arts Festival, where it won the award for New Artist in Digital + Interactive. It is also slated to appear at the Honolulu Museum of Art's 2024 Native American Heritage Month exhibition.</p>",
        },
